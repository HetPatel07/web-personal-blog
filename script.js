...
// const currentCard = $("#roboFriends");

$('#roboFriends').click(function(){
  window.location.href='https://hetpatel07.github.io/react-RoboFriends/';
});
$('#lunatic').click(function(){
  window.location.href='https://lunaticclone.netlify.app/';
});
$('#starAdvertising').click(function(){
  window.location.href='https://star-advertising.netlify.app/index.html';
});
